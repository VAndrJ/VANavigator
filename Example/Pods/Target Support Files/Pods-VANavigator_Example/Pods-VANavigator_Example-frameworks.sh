...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Swiftional/Swiftional.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Texture/AsyncDisplayKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/VANavigator/VANavigator.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/VATextureKit/VATextureKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/VATextureKitRx/VATextureKitRx.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/VATextureKitSpec/VATextureKitSpec.framework"
fi
